...
//
// ButtonsTab — Phase 3 Wave 1 PLACEHOLDER. The tabbed shell (Plan 01) ships this empty
// tab body so the StackLayout compiles and renders standalone; Wave 2 (Plan 02)
